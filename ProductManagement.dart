...
import 'package:pikaaya_customer_seller/SallerHomepage.dart';
      ...
      appBar: AppBar(
        title: Container(
          decoration: BoxDecoration(
            color: Colors.grey, // Background color of the search field
            borderRadius: BorderRadius.circular(20), // Border radius of the search field
          ),
          child: TextField(
            decoration: InputDecoration(
              hintText: 'Search...',
              border: InputBorder.none,
              contentPadding: EdgeInsets.symmetric(horizontal: 10, vertical: 5), // Padding inside the search field
            ),
          ),
        ),
        actions: [
